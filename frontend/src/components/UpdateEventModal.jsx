// components/UpdateEventModal.js
...
const UpdateEventModal = ({ isOpen, onClose, event, onEventUpdated }) => {
  ...
  const handleSubmit = async e => {
    ...
    const result = await Swal.fire({
      ...
      text: `¿Estás seguro de actualizar el evento "${formData.name}"?`,
      icon: 'question',
    ...
    try {
      ...
      let errorMessage = 'Hubo un error al actualizar el evento';
  ...
  const handleClose = () => {
    ...
    const hasData = Object.values(formData).some((value, key) => {
      ...
      if (
        ...
        return value !== formatDateForInput(event ? event[key] : '');
      }
