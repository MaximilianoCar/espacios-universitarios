...
const UpdateEventModal = ({ isOpen, onClose, event, onEventUpdated }) => {
  ...
  const handleSubmit = async e => {
    ...
    const result = await Swal.fire({
      ...
      text:
        schedules.length > 1
          ? `Se actualizarán ${schedules.length} eventos. ¿Continuar?`
          : `¿Estás seguro de actualizar el evento "${formData.name}"?`,
      icon: 'question',
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Especifique requerimientos especiales (máximo 2000 caracteres)"
                    maxLength={2000}
                  />
                  <div className="flex justify-between mt-1">
                    {errors.specialRequirements ? (
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    ...
                    máximo: 5MB (Opcional - deja vacío para mantener la imagen
                    actual)
                  </p>
                </div>
              </div>
